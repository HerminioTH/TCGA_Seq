...
class SaveData(object):
    def __init__(self, folderName, fileName, dataName='NONE'):
    ...
    def writeData(self, currentTime, data):
        if self.__writeHeader:
            self.__file.write('Time level, %s\n'%(self.__dataName))
...
def copySettings(source, destination):
